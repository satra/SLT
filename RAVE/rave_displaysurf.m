...
% $Id: rave_displaysurf.m 122 2005-11-29 08:39:13Z satra $
...
% l1 = light('position',[1 0 0],'color','w','style','infinite');
% l2 = light('position',[-1 0 0],'color','w','style','infinite');
% l3 = light('position',[0 0 1],'color','w','style','infinite');
% l4 = light('position',[0 0 -1],'color','w','style','infinite');

l1 = light('position',[-1 0 1],'color','w','style','infinite');
l2 = light('position',[1 0 0],'color','w','style','infinite');
l3 = light('position',[0 -1 -1],'color','w','style','infinite');
