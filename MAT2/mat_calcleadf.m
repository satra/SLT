function leadfield = mat_calcleadf(srcloc,srcori,sensloc,sensori,baseline)
...
for n0 = 1:numsrc,
    ...
    leadfield(:,n0) = mat_sarvasM(q,sensloc,ro,sensori)-mat_sarvasM(q,sensloc2,ro,sensori);
